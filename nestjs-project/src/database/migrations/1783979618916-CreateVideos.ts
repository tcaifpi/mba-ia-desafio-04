...
export class CreateVideos1783979618916 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_b4c5cb5bb46c7e33a6fe7408c0" ON "videos" ("unique_url_slug") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_b4c5cb5bb46c7e33a6fe7408c0"`);
